...
export default function FriendsAside({ onFriendClick }) {
    ...
    try {
        ...
        if (!querySnapshot.empty) {
            ...
            // Buscar o `msgBox` e garantir que ele seja um array
            let msgBox = userDoc.data().msgBox;
            if (!Array.isArray(msgBox)) {
                msgBox = [];
            }

            // Verificar se já existe um convite enviado
            const conviteJaEnviado = msgBox.some(
                (convite) => convite.ConviteFriends && convite.ConviteFriends.sender === userName
            );
    ...
    return (
    <aside className="FriendsAsideStyle">
        ...
        <div className="FriendsAsideContentAlignTwo">
            ...
            <div key={index} className="divStyleFriends">
